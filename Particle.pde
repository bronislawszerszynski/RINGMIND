...
class ShearParticle extends Particle {
  ...
  PrintWriter outputx = createWriter("shearOutX.csv");
  PrintWriter outputy = createWriter("shearOutY.csv");
  ...
  ShearParticle(ShearSystem s) {
    outputx.println("Time,xPosition,xVelocity,xAcceleration");
    outputy.println("Time,yPosition,yVelocity,yAcceleration");
  ...
  @Override PVector getAcceleration(System s) {
    ...
    if (ss.A) {//change this so acceleration is correctly calculated for whole ring instead of semi major axis.
...
void CollisionCheckB(ShearParticle B) {
  ...
  void out(){
    //output.println(s.totalSystemTime +","+ position.x +","+ position.y  +","+  velocity.x  +","+ velocity.y  +","+ acceleration.x  +","+ acceleration.y);
    outputx.println(s.totalSystemTime +","+ position.x +","+ velocity.x +","+ acceleration.x);
    outputy.println(s.totalSystemTime +","+ position.y +","+ velocity.y +","+ acceleration.y);
  }
